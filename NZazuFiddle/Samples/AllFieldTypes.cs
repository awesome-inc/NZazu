                ...
                Fiddle = ToFiddle(new FormDefinition
                    {
                        Fields = new[]
                        {
                            ...
                            new FieldDefinition
                            {
                                ...
                                Description =
                                    "Enter a single line string and get suggestion from any source using a provider",
                                Settings = new Dictionary<string, string>
                                {
                            ...
                            new FieldDefinition
                            {
                                ...
                                Hint = "shows an image",
                                Description =
                                    "use mouse click or space to toggle images. a single value just displays the image",
                                Values = new[]
                                {
