...
namespace NZazu.Fields
{
    ...
    internal class NZazuField_Should
    {
        ...
        {
            public NZazuDummyField(string key, FieldDefinition definition) : base(key, definition) { }
        ...
        {
            public NZazuField_With_Description_As_Content_Property(string key, FieldDefinition definition) : base(key, definition) { }
        ...
        {
            public GenericDummyField(string key, FieldDefinition definition) : base(key, definition) { }
        ...
        public void Validate_ctor_parameters()
        {
            ...
            0.Invoking(x => new NZazuDummyField("", new FieldDefinition())).ShouldThrow<ArgumentException>();
            1.Invoking(x => new NZazuDummyField(null, new FieldDefinition())).ShouldThrow<ArgumentException>();
            2.Invoking(x => new NZazuDummyField("\t\r\n ", new FieldDefinition())).ShouldThrow<ArgumentException>();
        ...
        {
            var sut = new NZazuDummyField("test", new FieldDefinition());
        ...
        public void Pass_Validation_To_Checks()
        {
            ...
            var sut = new NZazuDummyField("test", new FieldDefinition()) { Description = "description", Check = check };
            sut.Validate();
        ...
        {
            var field = new NZazuDummyField("key", new FieldDefinition());
        ...
        {
            var field = new NZazuField_With_Description_As_Content_Property("key", new FieldDefinition());
        ...
        public void Attach_FieldValidationRule_according_to_checks()
        {
            ...
            var sut = new NZazuField_With_Description_As_Content_Property("test", new FieldDefinition()) 
        ...
        {
            var sut = new GenericDummyField("test", new FieldDefinition());
