...
namespace NZazu.Fields
{
    ...
    internal class NZazuIntegerField_Should
    {
        ...
        {
            var sut = new NZazuIntegerField(new FieldDefinition { Key = "test" }, type => null);
        ...
        public void Format_TextBox_From_StringValue()
        {
            ...
            sut.SetStringValue("42");
            textBox.Text.Should().Be("42");

            sut.SetStringValue("-23");
            textBox.Text.Should().Be("-23");
        ...
        public void Format_StringValue_From_TextBox()
        {
            ...
            textBox.Text = "7";
            sut.GetStringValue().Should().Be("7");

            textBox.Text = "-12";
            sut.GetStringValue().Should().Be("-12");

            textBox.Text = "foo bar";
            sut.IsValid().Should().BeFalse();
            sut.GetStringValue().Should().Be("-12", because: "WPF binding cannot sync value");
